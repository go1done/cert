...
func GetConnectionState(startTLSType, connectName, connectTo, identity, clientCert, clientKey string, connectProxy *url.URL, timeout time.Duration, localIP string) (*tls.ConnectionState, *tls.CertificateRequestInfo, error) {
	var err error
